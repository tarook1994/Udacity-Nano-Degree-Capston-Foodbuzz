...
import example.foodbuzz.Adapters.CirclePageIndicator;
import example.foodbuzz.Adapters.ColorShades;
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrolled(final int position, float positionOffset, int positionOffsetPixels) {
                ...
                if(position==3||position==4){
                    findViewById(R.id.taroo2).setVisibility(View.VISIBLE);
                    findViewById(R.id.taroo2).setOnClickListener(new View.OnClickListener() {
                        @Override
                    ...
                    findViewById(R.id.taroo2).setVisibility(View.INVISIBLE);
